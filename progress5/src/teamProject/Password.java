...
public class Password extends JFrame {
    ...
    public Password(EscapeRoomMain EscapeRoomMain) {
        ...
        cancelButton.setBounds(12, 70, 147, 33); //y = 110 >> 70
        ...
        pwInputButton.setFont(new Font("Arial", Font.PLAIN, 25)); //BOLD
        pwInputButton.setBackground(Color.WHITE);
        pwInputButton.setBounds(183, 70, 191, 33); // y = 110 >> 70
        pwInputButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                passwordCheck("Correct! You got the clue.", "Try Again");
            }
        });
    ...
    public void passwordCheck(String successMessage, String failureMessage) {
        String inputPassword = new String(passwordField.getPassword());
        if ("323".equals(inputPassword)) {
    ...
    public void passwordCheck(String inputPassword, String successMessage, String failureMessage) {
        if ("323".equals(inputPassword)) {
            JOptionPane.showMessageDialog(null, successMessage);
            mainFrame.showClue2();
            dispose();
