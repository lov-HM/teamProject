...
public class EscapeRoomMain extends JFrame {
    ...
    private boolean clue1Visible;
    private boolean clue2Visible;
    private boolean clue3Visible;
    private boolean clue4Visible;
    private long startTime;
    private String playerName;
    SoundPlayer soundPlayer = new SoundPlayer();
    SoundPlayer2 effectPlayer = new SoundPlayer2();
    ...
    private void createMainMenu() {
        ...
        rankingButton.addActionListener(e -> {
        	createRankingPanel1();
            cardLayout.show(mainPanel, "Ranking1");
        });
    ...
    private void createOfficeRoom() {
        ...
        timerLabel.setFont(new Font("Noto Sans", Font.BOLD, 25));
        officeRoomPanel.add(timerLabel);
        ...
        key1button = new JButton(new ImageIcon("src/images/SmallBlueKey.png"));
        ...
        key2button = new JButton(new ImageIcon("src/images/RedSmallKey.png"));
    ...
    private void resetOfficeRoom() {
    	key1button.setBounds(900, 520, 100, 100);
        key2button.setBounds(10000, 300, 220, 220);
        
        clueLabel3.setLocation(20, 40);
    ...
    private void createRankingPanel1() {
        ...
        mainPanel.add(rankingPanel, "Ranking1");
    }
    
    private void createRankingPanel2() {
        RankingGUI ranking = new RankingGUI();
        String filePath = "src/Ranking.txt";
        JPanel rankingPanel = ranking.displayRanking(filePath);

        mainPanel.add(rankingPanel, "Ranking2");
    }
	...
	private void endCreateTypingPanel() {
	    ...
	    addSkipButtonToPanel(1000, 50, () -> {
	        skipped = true;
	        createRankingPanel2();
	        cardLayout.show(mainPanel, "Ranking2");
	...
	private void startShowTypingEffect() {
	    String[] texts = {
	        ...
	        + "원한다면 주도록 하지!\r\n"
	        + "어디 찾아봐라!\r\n"
	        + "프방론 A+ 받는 모든 방법을 거기에 두고왔다.",
	        "다루다루 : 뭐야! 이게 바로 고대 프방현자로부터 전해진 전설의 족보인가?\n"
	        + "아.. 조금 있으면 수업 시작인데 장난이면 어떡하지..?\n"
	        + "그래도 혹시나 모르니까 한번 가볼까?",
	        "다루다루 : 진짠가봐…! 아 이럴때가 아니지, 수업 전까지 빨리 찾아야겠다!!"
	    };
